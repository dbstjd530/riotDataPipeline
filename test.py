...
## 주요 룬 Style (runes_json에서 Slot 위치)
...
file_path = '/Users/yoonsung/Desktop/Project/ypgg/runes.json'
with open(file_path, 'w') as outfile:
    json.dump(runes_json, outfile, indent=4)
'''
...
spellImage_url = 'http://ddragon.leagueoflegends.com/cdn/13.9.1/img/spell/SummonerFlash.png'

# request.urlopen()
req = urllib.request.Request(spellImage_url, headers = request_header)
